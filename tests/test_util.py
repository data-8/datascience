...
def test_is_non_string_iterable():
    assert ds.is_non_string_iterable([1, 2, 3])
    assert ds.is_non_string_iterable((1, 2, 3))
    assert ds.is_non_string_iterable(np.array([1, 2, 3]))
    assert not ds.is_non_string_iterable(1)
    assert not ds.is_non_string_iterable("foo")